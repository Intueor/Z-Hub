...
const char m_chExtPort[] = "ExtPort";
...
const char m_chPseudonym[] = "Pseudonym";
const char m_chGroupID[] = "GroupID";
const char m_chLinks[] = "Links";
const char m_chPseudonyms[] = "Pseudonyms";
